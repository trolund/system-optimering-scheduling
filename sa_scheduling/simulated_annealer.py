...
class SimulatedAnnealer:
    ...
    def anneal(self, polling_servers, tt, t, a, n_solutions, current_cost, log_costs, best_cost):
        ...
        tmp_schedule, tmp_cost, is_schedulable = cost_functions.cost_f(tmp_solution)  # apply objective function
        ...
        # some logging
        if delta > 0:
            print("cost: ", tmp_cost, f" delta: {delta:.10f}", f" t: {t:.10f}",
                  f" p(delta, t): {self.p(delta, t):.10f}", " is schedulable: ", is_schedulable, " num_ps: ", len(pss))
        else:
            print("cost: ", tmp_cost, " delta: ", delta, " t: ", t, " is schedulable: ", is_schedulable, " num ps: ",
                  len(pss))

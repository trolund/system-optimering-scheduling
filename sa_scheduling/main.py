...
def generate_plot(cost_log, best_cost, filename):
    fig, ax = plt.subplots()
...
if __name__ == "__main__":
    ...
    # usually generates good solution, but should be random
    ...
    if is_logging:
        generate_plot(simulated_annealer.get_cost_log(), simulated_annealer.get_best_cost(), filename)
